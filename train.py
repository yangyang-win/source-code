...
def get_args():
    parser = argparse.ArgumentParser('End-to-End Perception Network')
    ...
    parser.add_argument('-n', '--num_workers', type=int, default=28, help='Num_workers of dataloader')
    ...
    parser.add_argument('--val_interval', type=int, default=100, help='Number of epoches between valing phases')
...
def train(opt):
    ...
    if opt.freeze_backbone:
        ...
        model.bn4.requires_grad_(False)
        model.conv5.requires_grad_(False)
        model.bn5.requires_grad_(False)
